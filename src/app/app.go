...
func (a *App) setRouters() {
	...
	a.Get("/hello", a.handleRequest(handler.GetHello))
	a.Post("/hello", a.handleRequest(handler.CreateHello))
	a.Put("/hello", a.handleRequest(handler.UpdateHello))
	a.Delete("/hello", a.handleRequest(handler.DeleteHello))
}
